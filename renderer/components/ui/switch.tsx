...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    className={cn(
      // `touch-target`: the track is 20px tall, well under the 44px a finger
      // needs — see styles.css. A mouse sees no change at all.
      "peer inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent touch-target",
