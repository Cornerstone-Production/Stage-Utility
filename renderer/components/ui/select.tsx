...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn("px-2 pb-1 pt-2 text-caption2 font-semibold uppercase tracking-wider text-gray-9", className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "px-2.5 py-1 text-footnote text-fg placeholder:text-gray-a8 whitespace-nowrap",
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 min-w-32 overflow-hidden rounded-md border border-line-strong bg-popover backdrop-blur-xl shadow-md",
...
>(({ className, children, value, ...props }, ref) => {
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "text-footnote text-fg outline-none",
      "focus:bg-fill data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className,
    )}
    {...props}
  >
