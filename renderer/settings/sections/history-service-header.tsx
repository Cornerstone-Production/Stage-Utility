...
export function serviceKpis(
  ...
  return [
    ...
    },
    {
      ...
      value: attendance ? servicePeakAttendance(attendance).toLocaleString() : "—",
      sub: attendance && attendance.peakOccupancy > 0 ? `${attendance.peakOccupancy.toLocaleString()} in room` : undefined,
    },
    {
      key: "level",
