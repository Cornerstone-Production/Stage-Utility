// api.ts — Drop-in replacement for window.glazeAPI.glaze.ipc
//
// invoke<T>(channel, params?) maps IPC channels to HTTP fetch calls.
 ...
 * Returns an unsubscribe function (same API as Glaze's onNotification).
 */
